...
SLEEP_SECONDS      = 1.0     # delay between each download to respect arXiv API

os.makedirs(DOWNLOAD_FOLDER, exist_ok=True)
os.makedirs(PARSED_TEXT_FOLDER, exist_ok=True)

def download_pdf(result, out_folder=DOWNLOAD_FOLDER):
    """Download the PDF for one paper result object."""
...
def main():
    print("=== Starting PDF download & parse step ===")
    ...
    print("=== Completed PDF download & parse step ===")
